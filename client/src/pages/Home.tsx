...
const reviewsJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "reviewRating": { "@type": "Rating", "ratingValue": 5, "bestRating": 5 },
      "reviewBody": "Jeremy bridges the gap between 'tech' and 'tactical.' This isn't just theory; it is the specific blueprint I needed to stop manually grinding and start strategically scaling. If you want to build a machine that works for you, read this.",
      "itemReviewed": { "@id": "https://keanonbiz.com/#professional-service" },
    ...
    },
    {
      ...
      "reviewRating": { "@type": "Rating", "ratingValue": 5, "bestRating": 5 },
      "reviewBody": "I was afraid automation would make my business feel robotic, but Jeremy proved the opposite. This method allowed me to 'clone' my values and voice, giving me more time with clients. A total game-changer.",
      "itemReviewed": { "@id": "https://keanonbiz.com/#professional-service" },
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex justify-center gap-6">
              <a href="https://www.linkedin.com/in/jeremykean1" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center gap-2">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-4 mt-2">
                  <a href="https://www.linkedin.com/in/jeremykean1" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-primary transition-colors" aria-label="Follow Jeremy on LinkedIn">
